...
function route(app, Bookshelf, io) {
  ...
  app.post('/createSinglePlayerGame', ensureLoggedIn('/login'), withTransaction(gameRoutes.createSinglePlayerGame));
  ...
  app.post('/getGame', withoutTransaction(gameRoutes.getGame));
}
