...
jQuery.fn.emoticons = function(icon_folder) {
    ...
    var icon_folder = icon_folder || "/img/emoticons";
    ...
    function emoticons(html){
        for(var emoticon in emotes){
            for(var i = 0; i < emotes[emoticon].length; i++){
              ...
              var regex = new RegExp('('+emotes[emoticon][i].replace(metachars, "\\$&")+')', 'g');
              html = html.replace(regex,"<img src=\""+icon_folder+"/face-"+emoticon+".png\" class=\"emoticonimg\" alt=\""+emotes[emoticon][i]+"\"/>");
            }
        }
        return html;
    }
